...
class CarouselDisplay extends Component {
    ...
    next = () => {
        ...
        const nextIndex = this.state.activeIndex === this.state.popularFilms.length - 1 ? 0 : this.state.activeIndex + 1;
        this.setState({ activeIndex: nextIndex });
    }

    previous = () => {
        if (this.animating) return;
        const nextIndex = this.state.activeIndex === 0 ? this.state.popularFilms.length - 1 : this.state.activeIndex - 1;
        this.setState({ activeIndex: nextIndex });
    }
    ...
    render() {
        ...
        let items = this.props.popularFilms.map(film => {
            return {
